...
<body>
    ...
    <main id="content" role="main">
        <!-- Hero Section -->
        <div class="bg-primary bg-img-hero space-lg-3"
            style="background-image: url(../../assets/svg/components/abstract-shapes-5.svg);">
            <div class="container ">
                <div class="w-lg-65 text-center mx-lg-auto">
                    <span class="badge badge-soft-light badge-pill font-size-1 py-3 px-4 mb-3">Customer success
                        story</span>
            ...
            <div class="row justify-content-lg-between">
                    ...
                    <article class="row mb-7">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column h-100 px-0">
                                ...
                                <h3><a class="text-inherit" href="single-article.html">Front becomes an official
                                        Instagram Marketing
                                        Partner</a></h3>
                                <p>Great news we're eager to share.</p>
                                <div class="media align-items-center mt-auto">
                                    <a class="avatar avatar-sm avatar-circle mr-3" href="blog-profile.html">
                                        <img class="avatar-img" src="../../assets/img/100x100/img3.jpg"
                    ...
                    <article class="row mb-7">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column h-100 px-0">
                                ...
                                <h3><a class="text-inherit" href="single-article.html">Announcing a free plan for small
                                        teams</a></h3>
                                <p>At Wake, our mission has always been focused on bringing openness.</p>
                                <div class="media align-items-center mt-auto">
                                    <a class="avatar avatar-sm avatar-circle mr-3" href="blog-profile.html">
                                        <img class="avatar-img" src="../../assets/img/100x100/img11.jpg"
                                            alt="Image Description">
                                    </a>
                                    <div class="media-body">
                                        <span class="text-dark">
                                            <a class="d-inline-block text-inherit font-weight-bold"
                                                href="blog-profile.html">Hanna Wolfe</a>
                                        </span>
                    ...
                    <article class="row mb-7">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column h-100 px-0">
                                ...
                                <h3><a class="text-inherit" href="single-article.html">Enjoy $1,000 worth of perks with
                                        Front for
                                        Business</a></h3>
                                ...
                                <div class="media align-items-center mt-auto">
                                    ...
                                    <div class="media-body">
                                        <span class="text-dark">
                                            <a class="d-inline-block text-inherit font-weight-bold"
                                                href="blog-profile.html">Andrea Gard</a>
                                        </span>
                    ...
                    <article class="row mb-7">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column h-100 px-0">
                                ...
                                <h3><a class="text-inherit" href="single-article.html">What CFR (Conversations,
                    ...
                    <article class="row mb-7">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column h-100 px-0">
                                ...
                                <h3><a class="text-inherit" href="single-article.html">Do millennials care about
                                        saving?</a></h3>
                                <p>Over the last few years, numerous studies have appeared to confirm a troubling
                                    pattern – millennials
                    ...
                    <article>
                        <a class="card align-items-start flex-wrap flex-row h-380rem gradient-x-overlay-sm-navy bg-img-hero rounded-pseudo transition-3d-hover mb-7"
                            ...
                            <div class="card-footer border-0 bg-transparent mt-auto">
                                <h3 class="h2 text-white">Facebook is creating a news section in Watch to feature
                                    breaking news</h3>
                    ...
                    <article class="row mb-7">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column h-100 px-0">
                                ...
                                <h3><a class="text-inherit" href="single-article.html">Front accounts - let's work
                                        together</a></h3>
                                <p>Are you an accountant? Are you a company formation advisor? Would you like to partner
                                    with one of the
                    ...
                    <article class="row mb-7">
                        ...
                        <div class="col-md-7">
                            <div class="card-body d-flex flex-column h-100 px-0">
                                ...
                                <h3><a class="text-inherit" href="single-article.html">Let's revolutionise global
                                        payments. Together</a>
                                </h3>
                ...
                <div class="col-lg-3">
                        ...
                        <div class="container justify-content-center">
                            <div class="row">
                                <div class="input-group mb-3"> <input type="text" class="form-control input-text"
                                    ...
                                    <div class="input-group-append"> <button class="btn btn-outline-primary btn-md"
                    ...
                    <div class="list-group mb-7">
                        ...
                        <a class="list-group-item list-group-item-action" href="#"><i
                                class="fas fa-tasks list-group-icon"></i>
                            Tasks</a>
                        <a class="list-group-item list-group-item-action" href="#"><i
                                class="fas fa-layer-group list-group-icon"></i> Projects</a>
                        <a class="list-group-item list-group-item-action" href="#"><i
                                class="fas fa-users list-group-icon"></i>
                            Members</a>
                    </div>
                    <!--------- End popular section----->
                        ...
                        <div class="mb-7">
                            ...
                            <article class="mb-5">
                                <div class="media align-items-center text-inherit">
                                    ...
                                    <div class="media-body">
                                        <h4 class="h6 mb-0"><a class="text-inherit" href="#">Mapping the first family
                                                tree for Front
                                                office</a></h4>
                                    </div>
                                </div>
